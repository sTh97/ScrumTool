...
const {calculateActualHours} = require("../utils/calculateActualHours")
...
//Update New for Actual Hours

// const calculateActualHours = (activeSessions = []) => {
...
exports.updateTask = async (req, res) => {
  try {
    ...
    // ✅ Always recalculate actual hours from sessions
    task.actualHours = calculateActualHours(task.activeSessions);
